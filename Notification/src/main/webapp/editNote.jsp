	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<a id="noteBookView" href="noteBooks.jsp">NoteBooks</a> 
			...
			<div class="modal-body mx-3">
				<form action="updateNote" method="post">
					...
					<label for="noteBookName">NoteBookName</label> 
						<input type="text" name="noteName" id="noteName" placeholder= "Notename" > 
					 ...
					 <label for="startDate">StartDate</label> <input type="date"
						id="startDate" name="startDate" placeholder="StartDate ">

					<label for="endDate">EndDate</label> <input type="date"
						id="endDate" name="endDate" placeholder="EtartDate " >

					<label for="remainderDate">RemainderDate</label> <input type="date"
						id="remainderDate" name="remainderDate" placeholder="RemainderDate"><br>
					 <label
						for="statusName">Status</label> <select id="statusName"
						name="statusName" placeholder="Status ">
						
						<option value="false">Started</option>
						
						<option value="true">Completed</option>
					</select>  <label for="noteDescription">Description</label>
					<textarea id="noteDescription" name="noteDescription" placeholder="Description"
