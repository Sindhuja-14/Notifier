	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<h3 style="color: white;">Hai <c:out value='${userName}'/> </h3>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body mx-3">
						<form action="createNoteBook" name="myForm"
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-1 text-left"><b>
										<a  href="notes" itemId=${item.key.getId()}"> <% String notebook_name=(String) request.getAttribute("nb_name"); out.print(notebook_name); %> 
										</a></b>
										<div>
									      <c:out value=" Notes" />
									   </div>
									...
									<div class="col-md-10 text-right">
										<a id="editNoteBook" href="editNoteBook.jsp" itemId=${item.key.getId()}"><span
											class="glyphicon glyphicon-edit">Edit</span></a>
									</div>
									<div>
										<a id="deleteNoteBook"  href="deleteNoteBook?itemId=${item.key.getId()}"><span
