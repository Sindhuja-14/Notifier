...
<body>
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<a id="editUser" href="editUser">Edit User</a>
			</div>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a  id="addNewNote" href="" data-toggle="modal"
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
					...
					<form action="createNote" method="post" onsubmit="return validateNoteForm()">
					   ...
					   <p id="status_error" style="display: none; color: red;">Status should not be empty</p>
					    <select id="statusName"name="statusName" >
							<option value="false">Started</option>
	...
	<tr>
				<div id="message" style="color: red; display: block"></div></td>
...
<c:forEach items="${noteObjDate}" var="note"> 
			<h3><a id="dailyTask"
				href="showNote"><% String nname=(String)request.getAttribute("note_name"); out.print(nname); %></a></h3>
			<p>StartDate :<% String sdate=(String)request.getAttribute("start_date"); out.print(sdate); %></p>
			<p>EndDate   : <% String edate=(String)request.getAttribute("end_date"); out.print(edate); %> </p>
		...
		<% i=i+1; %>
			<tr>
				...
				<div name="myTable">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-1 text-left">
											<a  id="notedetails" href="showNote"> <% String nname=(String)request.getAttribute("note_name"); out.print(nname); %>
												
												</a>
										</div>
										<div class="col-md-2 text-left">Started on: <% String sd=(String)request.getAttribute("start_date"); out.print(sd); %></div>
										...
										<div class="col-md-10 text-right">
											<a id="editNote"  href="editNote.jsp" itemId=${item.getId()}"><span
                    ...
                    <div class="panel-body">
                  <% String des=(String)request.getAttribute("desc"); out.print(des); %>
                     </div>
