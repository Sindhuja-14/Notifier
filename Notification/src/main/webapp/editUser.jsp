			...
			<div class="modal-body mx-3">
				<form action="updateUser" method="post">
					...
					<label for="userName">UserName</label> <input type="text" id="userName"
						name="userName" value=<% String uname= request.getAttribute("uname").toString(); out.print(uname); %>> 
						<input type="hidden" name="userId" value=<% int id_= (int)request.getAttribute("id_"); out.print(id_); %>> <label
						for="mobileNumber">MobileNumber</label> <input type="text"
						id="mobileNumber" name="mobileNumber"
						value=<% String mobile_num= request.getAttribute("mn").toString(); out.print(mobile_num); %>> <label for="email">Email</label>
					<input type="email" id="email" name="email"
						value=<% String email= request.getAttribute("em").toString(); out.print(email); %>> <label for="password">Password</label>
					<input type="password" id="password" name="password"
						value=<% String pass= request.getAttribute("pass").toString(); out.print(pass); %>>
